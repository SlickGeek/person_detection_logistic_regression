...
def load_dataset():
    dataset = h5py.File('/home/henrry/Documents/TEC2/IA/FinalProject/person_detection_logistic_regression/ai_backend/static/dataset/train_personvnonperson.hdf5', "r")
